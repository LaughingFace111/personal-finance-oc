    ...
    <div style={{ paddingBottom: 80 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontSize: 16, fontWeight: 600 }}>支出分布图</span>
        </div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 15, fontWeight: 500 }}>支出合计</div>
          <PeriodComparison data={comparison} compact inverted />
        </div>
        <span style={{ fontSize: 18, fontWeight: 600, color: 'var(--accent-red)' }}>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* 排名列表 */}
          <Card style={{ borderRadius: 12 }} title="支出排名">
              ...
              return (
                <div key={item.id || idx} style={{
                  ...
                  <div style={{
                    ...
                    height: 24,
                    borderRadius: 12,
                    background: idx < 3 ? 'var(--accent-red)' : 'var(--bg-elevated)',
                  ...
                  <div style={{ fontWeight: 500, color: 'var(--accent-red)' }}>
